...
import com.mobinsight.server.Survey;
...
/**
 * Exploring how Datanucleus works on Google AppEngine
 * for interacting with their NoSQL database (Alfred W).
 * xxxx
 */
public class DatastoreServlet extends HttpServlet {
	private Logger LOG = Logger.getLogger(DatastoreServlet.class.getSimpleName());
